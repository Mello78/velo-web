        ...
        <div className="mx-auto flex h-[74px] items-center justify-between px-5 sm:px-7">
          <Link href="/" className="flex items-center gap-3 shrink-0">
            ...
            <div className="leading-none">
              <span className="text-[#8a3e1e] text-[1.15rem] tracking-[0.34em] font-light" style={{ fontFamily: 'Cormorant Garamond, Georgia, serif' }}>VELO</span>
              <div className="mt-1 hidden text-[9px] uppercase tracking-[0.28em] text-[#7a6754] sm:block">from yes to forever</div>
            </div>
          </Link>
